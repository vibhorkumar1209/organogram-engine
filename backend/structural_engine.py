...
_DEPT_REMAP: dict[str, str] = {
    ...
    "product & engineering":            "Engineering / IT",
    # ── Sales (all variants) ─────────────────────────────────────────────
    "key accounts":                     "Sales",
    ...
    # ── Marketing (absorbs Communications/PR) ────────────────────────────
...
_DEPT_ELEVATE: dict[str, tuple[str, str]] = {
    # ── Legal & Compliance sub-depts ────────────────────────────────────
    "legal & compliance":               ("Legal & Compliance", "Legal Counsel"),
    "compliance & legal":               ("Legal & Compliance", "Legal Counsel"),
    "legal and compliance":             ("Legal & Compliance", "Legal Counsel"),
    "compliance":                       ("Legal & Compliance", "Regulatory Affairs"),
    "legal & regulatory":               ("Legal & Compliance", "Regulatory Affairs"),
    "legal, compliance & regulatory":   ("Legal & Compliance", "Regulatory Affairs"),
    "regulatory affairs":               ("Legal & Compliance", "Regulatory Affairs"),
    "regulatory":                       ("Legal & Compliance", "Regulatory Affairs"),
    "governance":                       ("Legal & Compliance", "Governance"),
    "secretariat":                      ("Legal & Compliance", "Corporate Secretary"),
    "company secretary":                ("Legal & Compliance", "Corporate Secretary"),
    ...
    "programme management office":      ("Strategy", "Programme Management"),
    "pmo":                              ("Strategy", "Programme Management"),
    "epmo":                             ("Strategy", "Programme Management"),
    "project management":               ("Strategy", "Programme Management"),
    # ── Sales sub-depts ─────────────────────────────────────────────────
    "sales & account management":       ("Sales", "Account Management"),
    "sales & commercial":               ("Sales", "Sales Operations"),
    "account management":               ("Sales", "Account Management"),
    "key account management":           ("Sales", "Account Management"),
    "inside sales":                     ("Sales", "Direct Sales"),
    "new business development":         ("Sales", "Partnerships"),
    "new business":                     ("Sales", "Partnerships"),
    "business development":             ("Sales", "Partnerships"),
    "pre-sales":                        ("Sales", "Sales Operations"),
    "channel & partners":               ("Sales", "Partnerships"),
    "sales operations":                 ("Sales", "Sales Operations"),
    "commercial":                       ("Sales", "Sales Operations"),
    ...
    "enterprise accounts":              ("Sales", "Direct Sales"),
    "mid-market":                       ("Sales", "Direct Sales"),
    # ── Marketing sub-depts ─────────────────────────────────────────────
    "customer experience":              ("Customer Success", "Client Relations"),
    "customer success":                 ("Customer Success", "Client Relations"),
    ...
    "digital & performance marketing":  ("Marketing", "Performance Marketing"),
    ...
    "corporate communications":         ("Marketing", "Brand & Creative"),
    "public relations":                 ("Marketing", "Brand & Creative"),
    "pr":                               ("Marketing", "Brand & Creative"),
    "external affairs":                 ("Marketing", "Brand & Creative"),
    "public affairs":                   ("Marketing", "Brand & Creative"),
    # ── Finance & Accounting sub-depts ──────────────────────────────────
    "treasury":                         ("Finance & Accounting", "Treasury"),
    "internal audit":                   ("Finance & Accounting", "Audit & Risk"),
    "audit & assurance":                ("Finance & Accounting", "Audit & Risk"),
    "audit":                            ("Finance & Accounting", "Audit & Risk"),
    ...
    "payroll":                          ("Finance & Accounting", "Payroll"),
    "financial operations":             ("Finance & Accounting", "Financial Operations"),
    "control & reporting":              ("Finance & Accounting", "Control & Reporting"),
    ...
    "people analytics":                 ("Human Resources", "People Operations"),
    "diversity & inclusion":            ("Human Resources", "Employee Relations"),
    "dei":                              ("Human Resources", "Employee Relations"),
    "people operations":                ("Human Resources", "People Operations"),
    "employee relations":               ("Human Resources", "Employee Relations"),
    # ── Engineering / IT sub-depts ──────────────────────────────────────
    "data & analytics":                 ("Engineering / IT", "Data & AI"),
    "data engineering":                 ("Engineering / IT", "Data & AI"),
    "data science":                     ("Engineering / IT", "Data Science"),
    "analytics":                        ("Engineering / IT", "Data & AI"),
    "cybersecurity":                    ("Engineering / IT", "Cybersecurity"),
    "information security":             ("Engineering / IT", "Cybersecurity"),
    "cyber security":                   ("Engineering / IT", "Cybersecurity"),
    "it infrastructure":                ("Engineering / IT", "Infrastructure"),
    "infrastructure":                   ("Engineering / IT", "Infrastructure"),
    "application development":          ("Engineering / IT", "Software Development"),
    "software development":             ("Engineering / IT", "Software Development"),
    "enterprise architecture":          ("Engineering / IT", "Infrastructure"),
    "digital":                          ("Engineering / IT", "Software Development"),
    "devops":                           ("Engineering / IT", "Software Development"),
    "support services":                 ("Engineering / IT", "Support Services"),
    # ── R&D sub-depts ───────────────────────────────────────────────────
    ...
    "quality & compliance":             ("Operations", "Quality Assurance"),
    ...
    "manufacturing eng.":               ("Operations", "Production"),
    "maintenance":                      ("Operations", "Maintenance"),
    "reliability engineering":          ("Operations", "Maintenance"),
    # ── Customer Success sub-depts ───────────────────────────────────────
    "customer support":                 ("Customer Success", "Customer Support"),
    "client relations":                 ("Customer Success", "Client Relations"),
    "client success":                   ("Customer Success", "Client Relations"),
